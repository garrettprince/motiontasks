                ...
                {({ values, setFieldValue, isSubmitting, resetForm }) => (
                  <Form>
                    ...
                    <Field
                      as="textarea"
                      name="description"
                      className="w-full p-2 focus:border-gray-300 rounded-lg  focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-transparent resize-none mb-5 transition-all duration-150 ease-in-out focus:ring-inset-2 text-sm"
                      rows={2}
                      placeholder="Task description"
                      autoComplete="off"
                      required
                    ...
                    >
                      <SelectTrigger
                        className={`transition-all ease-in-out duration-100 border rounded-lg px-2 py-1 flex items-center justify-between cursor-pointer h-7 mb-5  ${
                          values.status === "Not Started"
